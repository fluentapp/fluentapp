...
class ExternalLinkService extends WidgetBase
{
    ...
    protected function handleDateRangeFilter(array $filterData): array
    {
        try {
            ...
            return ExternalLink::getExternalLinkClicksByDateRange($dates['from_date'], $dates['to_date'], $filterData);
        } catch (Exception $e) {
            throw new Exception($e->getMessage());
        }
    }
    ...
    protected function handleRealTimeFilter(array $filterData): array
    {
        try {
            ...
            return ExternalLink::getExternalLinkClicksPrevSec($secs, $filterData);
        } catch (Exception $e) {
            throw new Exception($e->getMessage());
        }
    }
